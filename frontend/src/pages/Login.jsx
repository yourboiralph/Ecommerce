...
const Login = () => {
  ...
  return <form className="flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800 ">
      ...
      <button onClick={onSubmitHandler} className="bg-black text-white font-light px-8 py-2 mt-4">{currentState === 'Login' ? "Login" : "Sign Up"}</button>
  </form>;
};
